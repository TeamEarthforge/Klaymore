 ...
 *
 * <p>工作原理（参考 CustomNPCs 的 CustomNpcResourceListener）：</p>
 * <ol>
...
public class KlaymoreResourceListener implements IResourceManagerReloadListener {
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        ...
        try {
            ...
            Klaymore.LOG.info(
                "[Klaymore] Injected asset pack from "
                    + MinecraftDirectory.getKlaymoreRoot().getAbsolutePath()
                    + " (domains: " + pack.getResourceDomains() + ")");
        } catch (Throwable t) {
    ...
    public static void register() {
        try {
            ...
            if (manager instanceof IReloadableResourceManager) {
                ...
                Klaymore.LOG.warn(
                    "[Klaymore] Cannot register resource listener: resource manager is "
